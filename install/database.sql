...
--
-- Host: localhost
-- Generation Time: Jan 29, 2023 at 09:16 AM
...
CREATE TABLE `{prefix}_inventory` (
  `id` int(11) NOT NULL,
  `category_id` varchar(10) COLLATE utf8_unicode_ci DEFAULT '0',
...
CREATE TABLE `{prefix}_number` (
  `type` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `key` varchar(10) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `{prefix}_orders` (
  ...
  `status` enum('IN','OUT','PO','QUO','RET') COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `{prefix}_stock` (
  ...
  `status` enum('IN','OUT','PO','QUO','RET') COLLATE utf8_unicode_ci DEFAULT NULL,
  `create_date` datetime NOT NULL,
  `topic` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
...
ALTER TABLE `{prefix}_category`
  ADD PRIMARY KEY (`type`,`category_id`);
