                ...
                try {
                    ...
                    if ($request->post('status')->toInt() == 0) {
                        if ($request->post('container')->toString() == ''){
                            ...
                            $get_job = \wms\case\Model::getContainer_ID($request->post('container')->toString());

                            $total_box = \wms\case\Model::Total_case($get_job[0]->container);
                      
                            $total_receive = \wms\case\Model::Total_Receive($get_job[0]->container);
                            ...
                            if ($get_job == false) {
                                ...
                                $ret['location'] = $request->getUri()->postBack('index.php', array('module' => 'wms-case', 
                            ...
                            if ($get_location == false) {
                                ...
                                if ($request->post('container')->toString() == ''){
                                    ...
                                    if ($scan_qr[0] == '') {
                                        ...
                                        $get_job = \wms\case\Model::getContainerNO($request->post('container')->toString());
        
                                        $checkBox = \wms\case\Model::GetBoxID($get_job[0]->container,$scan_qr[0]);
                                        ...
                                        if ($checkBox == false) {
                                            ...
                                            if ($checkBox[0]->receive_flg == 1) {
                                                ...
                                                // $get_material = \wms\case\Model::sumMaterial($get_job[0]->container);
                                                // $get_case = \wms\case\Model::SumCase($get_job[0]->container);
                                                // $get_box = \wms\case\Model::SumBox($get_job[0]->container);
                                                // $get_Qty = \wms\case\Model::SumQty($get_job[0]->container);                            
                                                ...
                                                $total_box = \wms\case\Model::Total_case($request->post('container')->toString());
            
                                                $total_receive = \wms\case\Model::Total_Receive($request->post('container')->toString());
