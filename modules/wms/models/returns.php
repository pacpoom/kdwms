        ...
        if ($request->initSession() && $request->isReferer() && $login = Login::isMember()) {
            if (Login::notDemoMode($login)) {
                try {
                    ...
                    if (count($scan_qr) >= 5) {
                        $get = \wms\returns\Model::GetBoxID($scan_qr[4]);
                       // var_dump($get);
                        if ($get == false) {
                            $ret['serial_number']='';
                            ...
                            $get_id = \wms\returns\Model::GetSoId($get[0]->id);
                            ...
                            if ($get_id == false) {
                                ...
                                $get_sum = \wms\returns\Model::GetSoSum($get_id[0]->sale_order,$get_id[0]->material_number);
                                ...
                                if ($get_sum == false) {
                                    ...
                                    $get_sum1 = \wms\returns\Model::GetSoSum($get_id[0]->sale_order,$get_id[0]->material_number);
                                    ...
                                    $ret['location'] = $request->getUri()->postBack('index.php', array('module' => 'wms-returns',
