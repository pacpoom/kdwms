...
class View extends \Gcms\View
{
    ...
    public function render($total_box,$total_receive,$container,$status,$location_code)
    {
        ...
        $form = Html::create('form', array(
            ...
            'class' => 'setup_frm',
            'autocomplete' => 'off',
            'action' => 'index.php/wms/model/receive/submit',
        ...
        $fieldset->add('a', array(
            ...
            'value' => 'Label',
            'href' => WEB_URL.'index.php?module=wms-receive&amp;status=1&amp;location='.''.'&amp;container='. $container .'&amp;total_box='. $total_box .'&amp;total_receive='. $total_receive .'&amp;',
        ));
        ...
        $fieldset->add('a', array(
            ...
            'value' => 'Label',
            'href' => WEB_URL.'index.php?module=wms-receive&amp;time='. date('His') .'&amp;',
        ));
