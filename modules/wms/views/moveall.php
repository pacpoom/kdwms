...
class View extends \Gcms\View
{
     ...
     * @return string
     */
    public function render($request,$total_box,$total_qty,$location_code,$status)
    {
        ...
        $form = Html::create('form', array(
            ...
            'class' => 'setup_frm',
            'autocomplete' => 'off',
            'action' => 'index.php/wms/model/moveall/submit',
        ...
        $fieldset = $form->add('fieldset', array(
            'title' => '{LNG_Location To Location}',
        ...
        $fieldset->add('a', array(
            ...
            'value' => 'Label',
            'href' => WEB_URL.'index.php?module=wms-moveall&amp;time='. date('His') .'&amp;',
        ));
    ...
    public function show_data($request,$location_code){
        ...
        $table = new DataTable(array(
            'uri' => $uri,
            'model' => \wms\moveall\Model::getContainer($location_code),
