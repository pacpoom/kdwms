...
class View extends \Gcms\View
{
    ...
    public function render($request,$material,$total_box,$total_qty)
    {
        ...
        $form = Html::create('form', array(
            ...
            'class' => 'setup_frm',
            'autocomplete' => 'off',
            'action' => 'index.php/wms/model/querylocation/submit',
        ...
        $fieldset->add('a', array(
            ...
            'value' => 'Label',
            'href' => WEB_URL.'index.php?module=wms-querylocation&amp;time='. date('His') .'&amp;',
        ));
    ...
    public function show_data($request,$raw){
        ...
        $table = new DataTable(array(
            'uri' => $uri,
            'model' => \wms\querylocation\Model::getContainer($raw),
