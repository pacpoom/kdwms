...
class View extends \Gcms\View
{
    ...
    public function render($index)
    {
        ...
        $table .= '<tr><td class="right nowrap">{LNG_Total Before Tax}</td><td></td><td><label class=g-input><input type=text class=result id=amount name=amount size=5 readonly></label></td><td class=right>'.$currency_unit.'</td></tr>';
        ...
        $table .= '<tr><td class="right nowrap">{LNG_Grand total}</td><td colspan=2 class=right id=grand_total>0.00</td><td class=right>'.$currency_unit.'</td></tr>';
        $table .= '<tr><td class="right nowrap"><label for=tax_status>{LNG_Withholding Tax}</label></td><td><span class=g-input><select name=tax_status id=tax_status>';
        ...
        $table .= '<tr class=due><td class="right nowrap">{LNG_Payment Amount}</td><td colspan=2 class="total right" id=payment_amount>0.00</td><td class=right>'.$currency_unit.'</td></tr>';
        // status
        $table .= '<tr><td class="right nowrap"><label for=status>{LNG_Status}<span class=tablet> (F9)</span></label></td><td colspan=3><span class="g-input icon-star0"><select id=status name=status>';
